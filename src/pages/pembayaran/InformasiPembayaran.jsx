            ...
            <div className='flex items-center lg:items-start flex-col lg:flex-row gap-4'>
                ...
                <div className='flex flex-col gap-3 lg:w-[35rem] h-fit border-[1.5px] border-secondary rounded-md px-2 py-3 lg:px-7 lg:py-6'>
                    <div className='flex flex-col lg:flex-row items-center w-full justify-between'>
                        ...
                        <span className='px-2 py-1 lg:px-5 lg:py-2 bg-orange-400 text-sm text-primary rounded-full'>Menunggu Pembayaran</span>
                    </div>
                    <div className='w-full bg-secondary h-[1px]'/>
                    <div className='flex flex-col gap-8 items-center'>
                        ...
                        <div className='flex flex-row items-center lg:px-0'>
                            <span className='w-60 lg:text-center text-2xl font-semibold'>0190784771</span>
                            <button className='flex flex-row gap-1 px-6 py-2 border-[1.5px] border-secondary rounded-full'>Salin</button>
                        </div>
