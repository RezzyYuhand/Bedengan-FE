        ...
        <div className='flex flex-col gap-16'>
            ...
            <div className='flex flex-col gap-24'>
                ...
                <div className="relative flex bg-[url('/images/background.JPG')] bg-cover bg-center min-h-[50vh] w-screen lg:w-auto place-content-center items-center">
                    <div className='absolute inset-0 bg-black opacity-60'></div>
                    <div ref={sec5Ref} className={`relative flex flex-col lg:flex-row lg:justify-between gap-7 lg:gap-0 items-center lg:items-center w-full px-14 lg:px-28 transition-opacity duration-1000 ${sec5InView ? 'opacity-100' : 'opacity-0'}`}>
                        <h1 className='text-lg lg:text-3xl text-white font-semibold w-56 max-w-full lg:w-[35rem] lg:max-w-[35rem]'>Sudah siap menikmati keindahan hutan pinus?</h1>
                        <Button onClick={handleButtonClick}>Reservasi Sekarang</Button>
                    </div>
                </div>
